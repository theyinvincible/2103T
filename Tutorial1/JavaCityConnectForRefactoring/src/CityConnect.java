...
public class CityConnect {
	...
	public static void main(String[] args) {
		showTextToUser(WELCOME_MESSAGE);
		while (true) {
			System.out.print("Enter command:");
			String command = scanner.nextLine();
			String userCommand = command;
			String feedback = executeCommand(userCommand);
			showTextToUser(feedback);
		}
	}
	...
	private static void showTextToUser(String text) {
	...
	private static String getDistance(String userCommand) {
		...
		int positionOfRoute = getPositionOfExistingRoute(newStartLocation, newEndLocation);

		if (positionOfRoute == NOT_FOUND) {
		...
		else 
		{
			return String.format(MESSAGE_DISTANCE, newStartLocation, newEndLocation,
					route[positionOfRoute][STORAGE_POSITION_DISTANCE]);
		}
